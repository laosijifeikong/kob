...
public class AcAppServiceImpl implements AcAppService {
    private final static String appId = "7191";
    private final static String appSecret = "4682c140e65a4713b6f5ec93fe3d7ec7";
    private final static String redirectUrl = "https://app7191.acapp.acwing.com.cn/api/user/account/acwing/acapp/receive_code";
    ...
    public JSONObject receiveCode(String code, String state) {
        ...
        String getString = HttpClientUtil.get(applyAccessToken, nameValuePairs);  //给第三方授权端发信息, 并接收来自第三方授权端的返回值
