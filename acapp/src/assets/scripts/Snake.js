import { DMCGameObject } from "./DmcGameObject";
import { Cell } from "./Cell";

export class Snake extends DMCGameObject {
    constructor(info, gamemap) {
        ...
        this.status = "idle"; //idle表示待机状态,move表示正在移动，die表示死亡

        this.dr = [-1, 0, 1, 0]; //上右下左偏移量
        this.dc = [0, 1, 0, -1];
    ...
    update_move() {
        ...
        if (distance < this.eps) {
            ...
            const move_distance = this.speed * this.timedelta / 1000; //每帧之间走的距离
